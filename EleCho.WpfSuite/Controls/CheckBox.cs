...
namespace EleCho.WpfSuite
{
    public class CheckBox : System.Windows.Controls.CheckBox
    {
        ...
        private static readonly Brush s_disabledGlyphBrush;
        private static readonly Geometry s_glyph;

        static CheckBox()
        {
            s_glyphBrush = new SolidColorBrush(Color.FromRgb(33, 33, 33));
            s_glyphBrush.Freeze();

            s_disabledGlyphBrush = new SolidColorBrush(Color.FromRgb(112, 112, 112));
            s_disabledGlyphBrush.Freeze();

            s_glyph = Geometry.Parse("F1 M 9.97498,1.22334L 4.6983,9.09834L 4.52164,9.09834L 0,5.19331L 1.27664,3.52165L 4.255,6.08833L 8.33331,1.52588e-005L 9.97498,1.22334 Z");
